...
//                        'beforeSend' => 'function() {$("#Beli_jumlah").find("option").remove();}',
            ...
            array(
                ...
                'ajax' => array(
                    'type' => 'POST',
                    'url' => CController::createUrl("Jual/SelectKeteranganparam",array('keterangan'=>$keterangan)),
                    'class' => 'span5',
                    //'update' => '#' . CHtml::activeId($model2, 'jumlah'), //jurusan_id = field jurusan_id
                    'update' => "#kode",
...
?>
<hr>
<h3><B>Keterangan : <i><?php echo $keterangan ?></i></B></h3>
<hr />
<h1><left>
<?php
echo CHtml::Button('Submit Pembelian', array('submit' => array('/beli/suksesKeterangan', 'id' => $id)));
?>
    </left></h1>
